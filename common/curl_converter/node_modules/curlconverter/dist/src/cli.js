...
import { parseArgs, curlLongOpts, curlLongOptsShortened, curlShortOpts, } from "./curl/opts.js";
import { buildRequests } from "./Request.js";
import { _toAnsible, toAnsibleWarn, supportedArgs as supportedArgsAnsible, } from "./generators/ansible.js";
import { _toC, toCWarn, supportedArgs as supportedArgsC, } from "./generators/c.js";
import { _toCFML, toCFMLWarn, supportedArgs as supportedArgsCFML, } from "./generators/cfml.js";
import { _toClojure, toClojureWarn, supportedArgs as supportedArgsClojure, } from "./generators/clojure.js";
import { _toCSharp, toCSharpWarn, supportedArgs as supportedArgsCSharp, } from "./generators/csharp.js";
import { _toDart, toDartWarn, supportedArgs as supportedArgsDart, } from "./generators/dart.js";
import { _toElixir, toElixirWarn, supportedArgs as supportedArgsElixir, } from "./generators/elixir.js";
import { _toGo, toGoWarn, supportedArgs as supportedArgsGo, } from "./generators/go.js";
import { _toHarString, toHarStringWarn, supportedArgs as supportedArgsHarString, } from "./generators/har.js";
import { _toHTTP, toHTTPWarn, supportedArgs as supportedArgsHTTP, } from "./generators/http.js";
import { _toHttpie, toHttpieWarn, supportedArgs as supportedArgsHttpie, } from "./generators/httpie.js";
import { _toJava, toJavaWarn, supportedArgs as supportedArgsJava, } from "./generators/java/java.js";
import { _toJavaHttpUrlConnection, toJavaHttpUrlConnectionWarn, supportedArgs as supportedArgsJavaHttpUrlConnection, } from "./generators/java/httpurlconnection.js";
import { _toJavaJsoup, toJavaJsoupWarn, supportedArgs as supportedArgsJavaJsoup, } from "./generators/java/jsoup.js";
import { _toJavaOkHttp, toJavaOkHttpWarn, supportedArgs as supportedArgsJavaOkHttp, } from "./generators/java/okhttp.js";
import { _toJavaScript, toJavaScriptWarn, javaScriptSupportedArgs as supportedArgsJavaScript, } from "./generators/javascript/javascript.js";
import { _toJavaScriptJquery, toJavaScriptJqueryWarn, supportedArgs as supportedArgsJavaScriptJquery, } from "./generators/javascript/jquery.js";
import { _toJavaScriptXHR, toJavaScriptXHRWarn, supportedArgs as supportedArgsJavaScriptXHR, } from "./generators/javascript/xhr.js";
import { _toJsonString, toJsonStringWarn, supportedArgs as supportedArgsJsonString, } from "./generators/json.js";
import { _toJulia, toJuliaWarn, supportedArgs as supportedArgsJulia, } from "./generators/julia.js";
import { _toKotlin, toKotlinWarn, supportedArgs as supportedArgsKotlin, } from "./generators/kotlin.js";
import { _toLua, toLuaWarn, supportedArgs as supportedArgsLua, } from "./generators/lua.js";
import { _toMATLAB, toMATLABWarn, supportedArgs as supportedArgsMATLAB, } from "./generators/matlab/matlab.js";
import { _toNode, toNodeWarn, nodeSupportedArgs as supportedArgsNode, } from "./generators/javascript/javascript.js";
import { _toNodeAxios, toNodeAxiosWarn, supportedArgs as supportedArgsNodeAxios, } from "./generators/javascript/axios.js";
import { _toNodeGot, toNodeGotWarn, supportedArgs as supportedArgsNodeGot, } from "./generators/javascript/got.js";
import { _toNodeHttp, toNodeHttpWarn, supportedArgs as supportedArgsNodeHttp, } from "./generators/javascript/http.js";
import { _toNodeKy, toNodeKyWarn, supportedArgs as supportedArgsNodeKy, } from "./generators/javascript/ky.js";
import { _toNodeRequest, toNodeRequestWarn, supportedArgs as supportedArgsNodeRequest, } from "./generators/javascript/request.js";
import { _toNodeSuperAgent, toNodeSuperAgentWarn, supportedArgs as supportedArgsNodeSuperAgent, } from "./generators/javascript/superagent.js";
import { _toOCaml, toOCamlWarn, supportedArgs as supportedArgsOCaml, } from "./generators/ocaml.js";
import { _toObjectiveC, toObjectiveCWarn, supportedArgs as supportedArgsObjectiveC, } from "./generators/objectivec.js";
import { _toPerl, toPerlWarn, supportedArgs as supportedArgsPerl, } from "./generators/perl.js";
import { _toPhp, toPhpWarn, supportedArgs as supportedArgsPhp, } from "./generators/php/php.js";
import { _toPhpGuzzle, toPhpGuzzleWarn, supportedArgs as supportedArgsPhpGuzzle, } from "./generators/php/guzzle.js";
import { _toPhpRequests, toPhpRequestsWarn, supportedArgs as supportedArgsPhpRequests, } from "./generators/php/requests.js";
import { _toPowershellRestMethod, toPowershellRestMethodWarn, supportedArgs as supportedArgsPowershellRestMethod, } from "./generators/powershell.js";
import { _toPowershellWebRequest, toPowershellWebRequestWarn, supportedArgs as supportedArgsPowershellWebRequest, } from "./generators/powershell.js";
import { _toPython, toPythonWarn, supportedArgs as supportedArgsPython, } from "./generators/python/python.js";
import { _toPythonHttp, toPythonHttpWarn, supportedArgs as supportedArgsPythonHttp, } from "./generators/python/http.js";
import { _toR, toRWarn, supportedArgs as supportedArgsR, } from "./generators/r.js";
import { _toRuby, toRubyWarn, supportedArgs as supportedArgsRuby, } from "./generators/ruby.js";
import { _toRust, toRustWarn, supportedArgs as supportedArgsRust, } from "./generators/rust.js";
import { _toSwift, toSwiftWarn, supportedArgs as supportedArgsSwift, } from "./generators/swift.js";
import { _toWget, toWgetWarn, supportedArgs as supportedArgsWget, } from "./generators/wget.js";
import fs from "fs";
...
let warnings = [];
try {
    [global, seenArgs] = parseArgs(argv, curlconverterLongOpts, curlLongOptsShortened, curlconverterShortOpts, undefined, warnings);
}
catch (e) {
    exitWithError(e);
}
